...
%Notice that current approaches that tend to mitigate unauthorized flow are affected by issues deriving from the use of a limited set of policies~\cite{TUD-CS-2014-0849}.
